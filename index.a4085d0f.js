 ...
 */var t1={},t2=t1={};function t6(){throw Error("setTimeout has not been defined")}function t4(){throw Error("clearTimeout has not been defined")}function t5(e){if(f===setTimeout)return setTimeout(e,0);if((f===t6||!f)&&setTimeout)return f=setTimeout,setTimeout(e,0);try{return f(e,0)}catch(t){try{return f.call(null,e,0)}catch(t){return f.call(this,e,0)}}}!function(){try{f="function"==typeof setTimeout?setTimeout:t6}catch(e){f=t6}try{p="function"==typeof clearTimeout?clearTimeout:t4}catch(e){p=t4}}();var t8=[],t3=!1,t7=-1;function t9(){t3&&g&&(t3=!1,g.length?t8=g.concat(t8):t7=-1,t8.length&&re())}function re(){if(!t3){var e=t5(t9);t3=!0;for(var t=t8.length;t;){for(g=t8,t8=[];++t7<t;)g&&g[t7].run();t7=-1,t=t8.length}g=null,t3=!1,function(e){if(p===clearTimeout)return clearTimeout(e);if((p===t4||!p)&&clearTimeout)return p=clearTimeout,clearTimeout(e);try{p(e)}catch(t){try{return p.call(null,e)}catch(t){return p.call(this,e)}}}(e)}}function rt(e,t){this.fun=e,this.array=t}function rr(){}t2.nextTick=function(e){var t=Array(arguments.length-1);if(arguments.length>1)for(var r=1;r<arguments.length;r++)t[r-1]=arguments[r];t8.push(new rt(e,t)),1!==t8.length||t3||t5(re)},rt.prototype.run=function(){this.fun.apply(null,this.array)},t2.title="browser",t2.browser=!0,t2.env={},t2.argv=[],t2.version="",t2.versions={},t2.on=rr,t2.addListener=rr,t2.once=rr,t2.off=rr,t2.removeListener=rr,t2.removeAllListeners=rr,t2.emit=rr,t2.prependListener=rr,t2.prependOnceListener=rr,t2.listeners=function(e){return[]},t2.binding=function(e){throw Error("process.binding is not supported")},t2.cwd=function(){return"/"},t2.chdir=function(e){throw Error("process.chdir is not supported")},t2.umask=function(){return 0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rg{constructor(){this.reject=()=>{},this.resolve=()=>{},this.promise=new Promise((e,t)=>{this.resolve=e,this.reject=t})}wrapCallback(e){return(t,r)=>{t?this.reject(t):this.resolve(r),"function"==typeof e&&(this.promise.catch(()=>{}),1===e.length?e(t):e(t,r))}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function np(e,...t){throw nm(e,...t)}function ng(e,...t){return nm(e,...t)}function nm(e,...t){if("string"!=typeof e){let r=t[0],n=[...t.slice(1)];return n[0]&&(n[0].appName=e.name),e._errorFactory.create(r,...n)}return nh.create(e,...t)}function ny(e,t,...r){if(!e)throw nm(t,...r)}function nv(e){let t="INTERNAL ASSERTION FAILED: "+e;throw nf(t),Error(t)}function nb(){var e;return"undefined"!=typeof self&&(null===(e=self.location)||void 0===e?void 0:e.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function n1(e){let t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";{if(function(e=rm()){return/iemobile/i.test(e)}(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(function(e=rm()){return/firefox\//i.test(e)}(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(function(e=rm()){return/blackberry/i.test(e)}(t))return"Blackberry";if(function(e=rm()){return/webos/i.test(e)}(t))return"Webos";if(function(e=rm()){let t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}(t))return"Safari";if((t.includes("chrome/")||function(e=rm()){return/crios\//i.test(e)}(t))&&!t.includes("edge/"))return"Chrome";if(function(e=rm()){return/android/i.test(e)}(t))return"Android";let r=e.match(/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/);if((null==r?void 0:r.length)===2)return r[1]}return"Other"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function n2(e,t=[]){let r;switch(e){case"Browser":r=n1(rm());break;case"Worker":r=`${n1(rm())}-${e}`;break;default:r=e}let n=t.length?t.join(","):"FirebaseCore-web";return`${r}/JsCore/${r3}/${n}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");

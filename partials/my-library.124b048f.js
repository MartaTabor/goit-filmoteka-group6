function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}var t=globalThis,r={},n={},i=t.parcelRequired7c6;null==i&&((i=function(e){if(e in r)return r[e].exports;if(e in n){var t=n[e];delete n[e];var i={id:e,exports:{}};return r[e]=i,t.call(i.exports,i,i.exports),i.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){n[e]=t},t.parcelRequired7c6=i);var s=i.register;s("g1uI7",function(e,t){}),s("40lI0",function(e,t){i("hGVxz");var r=i("9d9Fx"),n=i("cB4zx");let s=0;async function o(e){try{let t=(await (0,r.default).get("https://api.themoviedb.org/3/discover/movie?api_key=c2f18aa0c4ee94c87f87834077fd721a&language=en-EN")).data.results[e];console.log(`Id danego filmu: ${t.id}`);let i=await (0,r.default).get(`https://api.themoviedb.org/3/movie/${t.id}?api_key=c2f18aa0c4ee94c87f87834077fd721a&language=en-EN`),s=await (0,r.default).get("https://api.themoviedb.org/3/genre/movie/list?api_key=c2f18aa0c4ee94c87f87834077fd721a&language=en-EN"),o={};s.data.genres.forEach(e=>{o[e.id]=e.name});let a=t.genre_ids.map(e=>o[e]).slice(0,2).join(", "),l=document.querySelector(".film-details-modal-window"),u=` <a class="film-details-close" data-modal-close>
     <svg class="close-button" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><defs><style>.cls-1{fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;stroke-width:2px;}</style></defs><title/><g id="cross"><line class="cls-1" x1="7" x2="25" y1="7" y2="25"/><line class="cls-1" x1="7" x2="25" y1="25" y2="7"/></g></svg>
            ...
            <div class="film-details-modal" data-index="${e}">
                <div class="modal-film-poster-div">
                    <img class="modal-film-poster" src="https://image.tmdb.org/t/p/original/${i.data.poster_path}" />
                </div>
                <div class="modal-film-details-div">
                    <h4 class="film-title">${i.data.title}</h4>
                    <div class="modal-film-details">
                      <div class="data">
                        <h5 class="types">Vote/Votes</h5>
                        <p class="avg">${i.data.vote_average.toFixed(1)}</p>
                        <span class="slash">/</span>
                        <p class="number">${i.data.vote_count}</p>
                      </div>
                      <div class="data">
                        <h5 class="types">Popularity</h5>
                        <p class="number">${i.data.popularity.toFixed(0)}</p>
                      </div>
                      <div class="data">
                        <h5 class="types">Original Title</h5>
                        <p class="number">${i.data.original_title}</p>
                      </div>
                      <div class="data">
                    ...
                    <div class="film-overview">
                        ...
                        <p class="film-desc">${i.data.overview}</p>
                    </div>
                    <div class="buttons">
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ez{constructor(e){this.providerId=ez.PROVIDER_ID,this.auth=eo(e)}verifyPhoneNumber(e,t){return eH(this.auth,e,(0,n.getModularInstance)(t))}static credential(e,t){return eS._fromVerification(e,t)}static credentialFromResult(e){return ez.credentialFromTaggedObject(e)}static credentialFromError(e){return ez.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;let{phoneNumber:t,temporaryProof:r}=e;return t&&r?eS._fromTokenResponse(t,r):null}}ez.PROVIDER_ID="phone",ez.PHONE_SIGN_IN_METHOD="phone";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
//# sourceMappingURL=my-library.124b048f.js.map

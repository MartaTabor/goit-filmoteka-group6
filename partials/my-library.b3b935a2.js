var e=globalThis,a={},t={},i=e.parcelRequired7c6;null==i&&((i=function(e){if(e in a)return a[e].exports;if(e in t){var i=t[e];delete t[e];var r={id:e,exports:{}};return a[e]=r,i.call(r.exports,r,r.exports),r.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,a){t[e]=a},e.parcelRequired7c6=i),i.register;var r=i("hGVxz");let s=0;async function l(e){let a={method:"GET",url:"https://api.themoviedb.org/3/movie",params:{api_key:"5abbb3dbf9a78bf33887465dc33dbfa3",language:"en-US",append_to_response:"credits"},headers:{accept:"application/json"}},t=e.map(e=>(0,r.default).request({...a,url:`${a.url}/${e}`}));return(await Promise.all(t)).map(e=>e.data)}function n(e){let a=document.querySelector(".gallery-library");if(a.innerHTML="",!e||0===e.length){a.innerHTML=`
        ...
        <li class="home-film-item" data-index="${s++}" data-modal-open>
